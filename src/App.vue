  ...
  <div class="content">
   ...
   <div v-if="tabActive === 0">
    <div class="grid">
     <div class="cs1 ce12" style="margin-top: var(--space-medium)">
      <button className="button button-primary button-small" @click="translate" :disabled="!translateButtonEnabled">
       Translate selection
      </button>
   ...
   <div v-else>
    ...
    <div className="cs1 e12">
     ...
     <input type="password" className="input input-small" v-model="authKey" @change="() => (dirtySettings = true)" />
     <div class="hint">
...
<script lang="ts">
import { Card, Frame, Item, Shape, StickyNote, Text } from '@mirohq/websdk-types';
...
import { availableLanguages, getFullLanguagesNameFromShortHandle, pluralizeItems } from './utils';
